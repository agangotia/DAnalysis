...
public class OtherDataByCountServlet extends DataSourceServlet {
	 @Override
	  public DataTable generateDataTable(Query query, HttpServletRequest request) {
	    // Create a data table.
		 
		 System.out.println("\n com.dedupanalysis.phase1wothers.OtherDataByCountServlet Lets Crank it");
		 ArrayList<FileStatsVO>  ALFileStats=DedupDAOPh1WOther.fillOthersFileStatsByCount();
		 System.out.println("\n Cranked");
