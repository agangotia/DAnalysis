package com.dedupanalysis.phase1;
...
public class DataByCountServlet extends DataSourceServlet {
	 @Override
	  public DataTable generateDataTable(Query query, HttpServletRequest request) {
	    // Create a data table.
		 
		 System.out.println("\n com.dedupanalysis.phase1.DataByCountServlet Lets Crank it");
		 ArrayList<FileStatsVO>  ALFileStats=DedupDAOPh1.fillFileStatsByCount();
		 System.out.println("\n Cranked");
