...
public class DataBySizeServlet extends DataSourceServlet {
	 @Override
	  public DataTable generateDataTable(Query query, HttpServletRequest request) {
	    // Create a data table.
		 
		 System.out.println("\n com.dedupanalysis.phase1.DataBySizeServlet Lets Crank it");
		 ArrayList<FileStatsVO>  ALFileStats=DedupDAOPh1.fillFileStats();
		 System.out.println("\n Cranked");
